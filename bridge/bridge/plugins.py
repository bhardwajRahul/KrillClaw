"""
KrillClaw Plugin Discovery and Loading.

Scans ~/.krillclaw/plugins/*.py for user-defined tools.
...
Example plugin (~/.krillclaw/plugins/my_tool.py):
...
logger = logging.getLogger("krillclaw.plugins")

REQUIRED_EXPORTS = {"TOOL_NAME", "handle"}
PLUGINS_DIR = os.path.expanduser("~/.krillclaw/plugins")
...
def _load_plugin(path: str):
    ...
    module_name = f"krillclaw_plugin_{fname[:-3]}"
