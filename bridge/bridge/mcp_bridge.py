...
Config file: ~/.krillclaw/mcp_servers.json (Claude Desktop compatible format)
...
logger = logging.getLogger("krillclaw.mcp")
...
class MCPBridge:
    ...
    def load_config(self, path=None):
        ...
        if path is None:
            path = os.path.expanduser("~/.krillclaw/mcp_servers.json")
